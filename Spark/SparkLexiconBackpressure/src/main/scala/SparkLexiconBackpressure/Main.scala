package SparkLexiconBackpressure
...
object Main {
  ...
  def main(args: Array[String]) {
    ...
    val sparkConf = new SparkConf().setAppName("SparkLexiconBackpressure").set("spark.streaming.backpressure.enabled","true").set("spark.streaming.kafka.maxRatePerPartition",config.getInt("cluster.spark.maxRatePerPartition").toString).set("spark.streaming.backpressure.pid.minRate", "1")
